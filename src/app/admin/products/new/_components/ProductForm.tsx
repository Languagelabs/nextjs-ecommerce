...
export function ProductForm({product}: {product?: Product | null}) {
  const [error, action] = useFormState(product == null ? addProducts : updateProduct.bind(null, product.id), {})
  ...
  return (
    <form action={action} className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        {product != null && (
          <Image src={product.imagePath} width='300' height='300' alt={product.name} />
        )}  
